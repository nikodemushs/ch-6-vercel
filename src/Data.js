export const data = [
  {
    ...
    javelin: {
      hint: [
        "Passive: Pierce Grants each attack a 25% chance to pierce through evasion and deal 60 bonus magical damage.",
      ],
      id: 7,
    ...
    angels_demise: {
      hint: [
        "Passive: Empower Spell The next Unit Target spell you cast on an enemy deals 150 + 75% of your attack damage as bonus damage to the target, and slows them by 50% for 1.5s.",
    ...
    vladmir: {
      hint: [
        "Passive: Vladmir's Aura Grants 20% lifesteal, 18% bonus damage, 1 mana regeneration, and 2 armor to nearby allies. Lifesteal from creeps is reduced by 40%.\n\nRadius: 1200",
      ],
      id: 81,
    ...
    black_king_bar: {
      hint: [
        "Active: Avatar Applies a basic dispel. Grants 60% Magic resistance and immunity to pure and reflected damage. For the duration of the effect, any negative effect from enemy spells has no effect. \n\nDuration: 9 \nDispel Type: Basic Dispel ",
      ],
      id: 116,
    ...
    rapier: {
      hint: [
        "Toggle: Transmute Toggle to gain either 25% bonus spell amplification or 250 bonus attack damage.",
        "Passive: Everlasting Dropped on death, and cannot be destroyed. \n\nBecomes unusable if picked up by an ally of its owner until it is returned to its owner. It is immediately usable by anybody if an enemy of the owner picks it up and is killed. A dropped Rapier cannot be picked up by a courier.",
      ],
      id: 133,
    ...
    invis_sword: {
      hint: [
        "Active: Shadow Walk Makes you invisible for 17 seconds, or until you attack or cast a spell. While Shadow Walk is active, you move 20% faster and can move through units. \n\nIf attacking to end the invisibility, you gain 175 bonus physical damage on that attack.",
      ],
      id: 152,
    ...
    silver_edge: {
      hint: [
        "Active: Shadow Walk Makes you invisible for 17 seconds, or until you attack or cast a spell. While invisible, you move 25% faster and can move through units. \n\nAttacking to end the invisibility will deal 300 bonus physical damage and disable their passive abilities for 5 seconds.",
      ],
      id: 249,
    ...
    mjollnir: {
      hint: [
        ...
        "Passive: Chain Lightning Grants a 25% chance on attack to release a bolt of electricity that leaps between 12 targets within a 650 radius, dealing 180 magical damage to each. Lightning proc pierces evasion. Deals 150% damage to illusions.",
      ],
      id: 158,
    ...
    maelstrom: {
      hint: [
        "Passive: Chain Lightning Grants a 25% chance on attack to release a bolt of electricity that leaps between 4 targets within a 650 radius, dealing 120 magical damage to each. Lightning proc pierces evasion. Deals 150% damage to illusions.",
      ],
      id: 166,
    ...
    gungir: {
      hint: [
        ...
        "Passive: Chain Lightning Grants a 25% chance on attack to release a bolt of electricity that leaps between 4 targets within a 650 radius, dealing 160 magical damage to each. Lightning proc pierces evasion. Deals 150% damage to illusions.",
      ],
      id: 1466,
    ...
    disperser: {
      hint: [
        "Active: Suppress Slows the target for 5 seconds if they are an enemy or grants bonus movespeed, applies Basic Dispel and makes them unslowable for 5 seconds if they are an ally. Caster is always granted the ally benefit on cast.\n\nBoth movement speed reduction and increase start at 100% and gradually decrease to 0% over the course of the buff duration.\n\nRange: 600\nDispel Type: Basic Dispel ",
        "Passive: Manabreak Each attack burns 40 mana from the target, and deals 1 physical damage per burned mana. \n\nBurns 8 mana per attack from melee illusions and 8 mana per attack from ranged illusions.",
      ],
      id: 1097,
    ...
    mage_slayer: {
      hint: [
        "Passive: Mage Slayer Places a debuff when you attack enemies, dealing 25 damage per second and causing them to do 40% less spell damage for 3 seconds.",
      ],
      id: 598,
    ...
    revenants_brooch: {
      hint: [
        "Toggle: Phantom Province When enabled, attacks cost 50 mana, deal magical damage, and can hit ethereal units, but cannot crit.",
      ],
      id: 911,
    ...
    devastator: {
      hint: [
        "Passive: Witch Blade Causes your next attack to have true strike, apply a poison for 4 seconds, slowing by 25% and dealing 0.75x your intelligence as damage every second.",
    ...
    royal_jelly: {
      hint: [
        "Active: Consume Consumes all charges and grants a target allied unit a buff that provides +2.5 Health Regen and +1.25 Mana Regen per charge for 8s. \n\nIf the unit is attacked by an enemy hero or Roshan, the effect is lost.",
      ],
      id: 305,
    ...
    panic_button: {
      hint: [
        "Passive: Rejuvenate When the wearer's health falls below 20%, they will receive a hard dispel and be healed for 1250 health.",
      ],
      id: 365,
    ...
    safety_bubble: {
      hint: [
        "Passive: Bubbled Up Equipped Hero has a 100 HP Barrier against enemy damage. Barrier fully regenerates after not receiving damage for 8 seconds. Self-inflicted damage bypasses the barrier.",
      ],
      id: 1157,
    ...
    unwavering_condition: {
      hint: [
        "Passive: Unwavering Hero's Max Health is set to 1800 and can't be altered by other effects or attributes.",
      ],
      id: 1161,
    ...
    doubloon: {
      hint: [
        "Toggle: Flip Toggle to convert 20% of your Max Health to Max Mana, or 20% of your Max Mana to Max Health. Mana and health regeneration from Doubloon is increased by 50%, based on the which side is selected.",
      ],
      id: 1803,
